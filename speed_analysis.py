...
def speed_analysis_2():
    for batch in example_preprocessing_2():
        ...
        for i in range(10):
            ...
            with open("wall_query_LOOKUP_results_sqlite_1.txt", "a") as f:
                f.write("\n")
            with open("cpu_query_LOOKUP_results_sqlite_1.txt", "a") as f:
                f.write("\n")

            with open("wall_query_LOOKUPWIK_results_sqlite_1.txt", "a") as f:
                f.write("\n")
            with open("cpu_query_LOOKUPWIK_results_sqlite_1.txt", "a") as f:
                f.write("\n")
