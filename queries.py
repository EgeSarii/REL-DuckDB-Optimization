...
class DB:
    ...
    def lookup(self, w, table_name, column="emb"):
        ...
        end_wall = time.time()
        end_cpu = time.process_time()
        with open("wall_query_LOOKUP_results_sqlite_1.txt", "a") as o:
            o.write( "{}, ".format(end_wall- start_wall))
        with open("cpu_query_LOOKUP_results_sqlite_1.txt", "a") as o:
            o.write( "{}, ".format(end_cpu- start_cpu))  
        return res
    ...
    def lookup_wik(self, w, table_name, column):
        ...
        if column == "lower":
            ...
            with open("wall_query_LOOKUPWIK_results_sqlite_1.txt", "a") as o:
                o.write( "{}, ".format(end_wall- start_wall))
            with open("cpu_query_LOOKUPWIK_results_sqlite_1.txt", "a") as o:
                o.write( "{}, ".format(end_cpu- start_cpu))  
